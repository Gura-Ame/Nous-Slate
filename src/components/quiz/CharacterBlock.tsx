...
export function CharacterBlock({
  ...
  return (
    <div className={cn(
      ...
      borderColor,
      status === "active" && "shadow-[0_0_0_4px_rgba(var(--primary),0.1)] scale-105 z-10"
    )}>
      ...
      <div className={cn(
        ...
        {status === "active" && !char && !symbols && (
          <span className="absolute inset-0 flex items-center justify-center animate-pulse text-slate-300 text-4xl pointer-events-none">_</span>
        )}
      </div>
