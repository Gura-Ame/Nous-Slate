...
export function CardListSidebar({ cards, loading, editingCardId, onSelect, onDelete }: CardListSidebarProps) {
  return (
              ...
              >
                <div className="overflow-hidden">
                  <div className="font-bold text-lg truncate pr-2">
                    {/* 根據題型顯示標題 */}
                    {card.type === 'term' || card.type === 'flashcard' ? card.content.stem : 
