...
export function CardPreview({ type, stem, zhuyinRaw, definition, audioUrl, image }: CardPreviewProps) {
    ...
    <div className="p-8 border-2 border-dashed rounded-xl bg-slate-100/50 dark:bg-slate-800/50 flex flex-wrap gap-4 justify-center min-h-40 items-center">
      ...
      {type === 'flashcard' && (
        <div className="flex flex-col items-center justify-center gap-4 text-center w-full">
           ...
           {audioUrl && (
             <Button variant="secondary" size="sm" onClick={playAudio} className="gap-2">
