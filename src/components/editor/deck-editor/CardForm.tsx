          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button type="button" onClick={onAutoFillMoedict} variant="outline" size="icon" disabled={moedictLoading}>
           ...
           <div className="grid gap-4 sm:grid-cols-2">
             <div className="space-y-2">
               ...
               <div className="flex gap-2">
                 ...
                 <Button type="button" onClick={onAutoFillDict} variant="outline" size="icon" disabled={dictLoading}>
