...
import { StatsService, type ChartDataPoint, type DashboardStats } from "@/services/stats-service";
...
import { BookOpen, BrainCircuit, Flame, History } from "lucide-react";
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
             {/* ... 使用之前的 StatCard ... */}
             <StatCard title="總複習次數" value={stats?.totalReviews || 0} icon={History} />
             <StatCard title="今日複習" value={stats?.todayCount || 0} icon={BrainCircuit} valueClassName="text-primary" />
             <StatCard title="連續打卡" value={`${stats?.streak || 0} 天`} icon={Flame} iconClassName="text-orange-500" />
             <StatCard title="擁有題庫" value={stats?.totalDecks || 0} icon={BookOpen} />
          </div>
